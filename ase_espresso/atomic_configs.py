...
atomic_configs = [
    ...
    # 21 Sc: [Ar] 3d1 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 1],
     [4, 0, 2]),
    # 22 Ti: [Ar] 3d2 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 2],
     [4, 0, 2]),
    # 23 V: [Ar] 3d3 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 3],
     [4, 0, 2]),
    # 24 Cr: [Ar] 3d5 4s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 5],
     [4, 0, 1]),
    # 25 Mn: [Ar] 3d5 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 5],
     [4, 0, 2]),
    # 26 Fe: [Ar] 3d6 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 6],
     [4, 0, 2]),
    # 27 Co: [Ar] 3d7 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 7],
     [4, 0, 2]),
    # 28 Ni: [Ar] 3d8 4s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 8],
     [4, 0, 2]),
    # 29 Cu: [Ar] 3d10 4s1
    ...
    # 39 Y: [Kr] 4d1 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 1], [5, 0, 2]),
    # 40 Zr: [Kr] 4d2 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 2], [5, 0, 2]),
    # 41 Nb: [Kr] 4d4 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 4], [5, 0, 1]),
    # 42 Mo: [Kr] 4d5 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 5], [5, 0, 1]),
    # 43 Tc: [Kr] 4d5 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 5], [5, 0, 2]),
    # 44 Ru: [Kr] 4d7 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 7], [5, 0, 1]),
    # 45 Rh: [Kr] 4d8 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 8], [5, 0, 1]),
    # 46 Pd: [Kr] 4d10
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10]),
    # 47 Ag: [Kr] 4d10 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 1]),
    # 48 Cd: [Kr] 4d10 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2]),
    # 49 In: [Kr] 4d10 5s2 5p1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 1]),
    # 50 Sn: [Kr] 4d10 5s2 5p2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 2]),
    # 51 Sb: [Kr] 4d10 5s2 5p3
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 3]),
    # 52 Te: [Kr] 4d10 5s2 5p4
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 4]),
    # 53 I: [Kr] 4d10 5s2 5p5
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 5]),
    # 54 Xe: [Kr] 4d10 5s2 5p6
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6]),
    # 55 Cs: [Xe] 6s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [6, 0, 1]),
    # 56 Ba: [Xe] 6s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [6, 0, 2]),
    # 57 La: [Xe] 5d1 6s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [5, 2,
                                                              1], [6, 0, 2]),
    # 58 Ce: [Xe] 4f1 5d1 6s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 1],
     [5, 2, 1], [6, 0, 2]),
    # 59 Pr: [Xe] 4f3 6s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3,
                                                              3], [6, 0, 2]),
    # 60 Nd: [Xe] 4f4 6s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3,
    ...
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 7],
     [5, 2, 1], [6, 0, 2]),
    # 65 Tb: [Xe] 4f9 6s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3,
    ...
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 14],
     [5, 2, 1], [6, 0, 2]),
    ...
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 14],
     [5, 2, 10], [6, 0, 2], [6, 1, 6], [7, 0, 1]),
    # 88 Ra: [Rn] 7s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 14],
     [5, 2, 10], [6, 0, 2], [6, 1, 6], [7, 0, 2]),
    # 89 Ac: [Rn] 6d1 7s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 14],
     [5, 2, 10], [6, 0, 2], [6, 1, 6], [6, 2, 1], [7, 0, 2]),
    # 90 Th: [Rn] 6d2 7s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [3, 2, 10],
     [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 2], [5, 1, 6], [4, 3, 14],
     [5, 2, 10], [6, 0, 2], [6, 1, 6], [6, 2, 2], [7, 0, 2])
]
