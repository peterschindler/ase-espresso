...
atomic_configs = [
    ...
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [
     3, 1, 6], [3, 2, 10], [4, 0, 2], [4, 1, 1]),
    # 32 Ge: [Ar] 3d10 4s2 4p2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [
     3, 1, 6], [3, 2, 10], [4, 0, 2], [4, 1, 2]),
    # 33 As: [Ar] 3d10 4s2 4p3
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [
     3, 1, 6], [3, 2, 10], [4, 0, 2], [4, 1, 3]),
    # 34 Se: [Ar] 3d10 4s2 4p4
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [
     3, 1, 6], [3, 2, 10], [4, 0, 2], [4, 1, 4]),
    # 35 Br: [Ar] 3d10 4s2 4p5
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [
     3, 1, 6], [3, 2, 10], [4, 0, 2], [4, 1, 5]),
    # 36 Kr: [Ar] 3d10 4s2 4p6
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [
     3, 1, 6], [3, 2, 10], [4, 0, 2], [4, 1, 6]),
    # 37 Rb: [Kr] 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6],
     [3, 2, 10], [4, 0, 2], [4, 1, 6], [5, 0, 1]),
    # 38 Sr: [Kr] 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6],
     [3, 2, 10], [4, 0, 2], [4, 1, 6], [5, 0, 2]),
    # 39 Y: [Kr] 4d1 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 1], [5, 0, 2]),
    # 40 Zr: [Kr] 4d2 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 2], [5, 0, 2]),
    # 41 Nb: [Kr] 4d4 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 4], [5, 0, 1]),
    # 42 Mo: [Kr] 4d5 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 5], [5, 0, 1]),
    # 43 Tc: [Kr] 4d5 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 5], [5, 0, 2]),
    # 44 Ru: [Kr] 4d7 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 7], [5, 0, 1]),
    # 45 Rh: [Kr] 4d8 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 8], [5, 0, 1]),
    # 46 Pd: [Kr] 4d10
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6],
     [3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 10]),
    # 47 Ag: [Kr] 4d10 5s1
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
     3, 2, 10], [4, 0, 2], [4, 1, 6], [4, 2, 10], [5, 0, 1]),
    # 48 Cd: [Kr] 4d10 5s2
    ([1, 0, 2], [2, 0, 2], [2, 1, 6], [3, 0, 2], [3, 1, 6], [
